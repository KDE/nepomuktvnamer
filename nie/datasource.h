...
{
public:
    DataSource(Nepomuk::SimpleResource* res)
      : m_res(res)
    {}
    ...
    void setDescriptions(const QStringList& value) {
        m_res->addProperty(Soprano::Vocabulary::RDF::type(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#DataSource", QUrl::StrictMode));
        QVariantList values;
