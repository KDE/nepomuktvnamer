...
{
public:
    FileHash(Nepomuk::SimpleResource* res)
      : m_res(res)
    {}
    ...
    void setDescriptions(const QStringList& value) {
        m_res->addProperty(Soprano::Vocabulary::RDF::type(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#FileHash", QUrl::StrictMode));
        QVariantList values;
     ...
     */
    QStringList hashAlgorithms() const {
        QStringList value;
        foreach(const QVariant& v, m_res->property(QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#hashAlgorithm", QUrl::StrictMode)))
            value << v.value<QString>();
        return value;
    }
     ...
     * might include CRC32, MD5, SHA, TTH etc. 
     */
    void setHashAlgorithms(const QStringList& value) {
        m_res->addProperty(Soprano::Vocabulary::RDF::type(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#FileHash", QUrl::StrictMode));
        QVariantList values;
        foreach(const QString& v, value)
            values << v;
        m_res->setProperty(QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#hashAlgorithm", QUrl::StrictMode), values);
    }
     ...
     * might include CRC32, MD5, SHA, TTH etc. 
     */
    void addHashAlgorithm(const QString& value) {
        m_res->addProperty(Soprano::Vocabulary::RDF::type(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#FileHash", QUrl::StrictMode));
        m_res->addProperty(QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#hashAlgorithm", QUrl::StrictMode), value);
    }
     ...
     */
    QStringList hashValues() const {
        QStringList value;
        foreach(const QVariant& v, m_res->property(QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#hashValue", QUrl::StrictMode)))
            value << v.value<QString>();
        return value;
    }
     ...
     * The actual value of the hash. 
     */
    void setHashValues(const QStringList& value) {
        m_res->addProperty(Soprano::Vocabulary::RDF::type(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#FileHash", QUrl::StrictMode));
        QVariantList values;
        foreach(const QString& v, value)
            values << v;
        m_res->setProperty(QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#hashValue", QUrl::StrictMode), values);
    }
     ...
     * The actual value of the hash. 
     */
    void addHashValue(const QString& value) {
        m_res->addProperty(Soprano::Vocabulary::RDF::type(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#FileHash", QUrl::StrictMode));
        m_res->addProperty(QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#hashValue", QUrl::StrictMode), value);
    }
