...
{
public:
    MediaFileListEntry(Nepomuk::SimpleResource* res)
      : m_res(res)
    {}

    virtual ~MediaFileListEntry() {}
...
protected:
    virtual QUrl resourceType() const { return QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#MediaFileListEntry", QUrl::StrictMode); }
